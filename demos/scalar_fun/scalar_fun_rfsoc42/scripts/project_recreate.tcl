...
#
# project_recreate.tcl: Tcl script for re-creating project 'scalar_fun_vivado'
#
# Generated by Vivado on Sun Oct 19 13:24:45 EDT 2025
...
#
# 1. This project restoration tcl script (project_recreate.tcl) that was generated.
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set paths [list \
 "[file normalize "$origin_dir/[file normalize "$origin_dir/../../scalar_fun_vitis/add/hls/impl/ip"]"]"\
  ]
  foreach ipath $paths {
...
set origin_dir "/home/wirelesslab914/sundeep/hwdesign/scalar_fun/scalar_fun_vivado/scripts"
...
set _xil_proj_name_ "scalar_fun_vivado"
...
set script_file "project_recreate.tcl"
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/../../../../../../../tools/Xilinx/Vivado/rfsoc2x2_board_files"]" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../scalar_fun_vitis/add/hls/impl/ip"]" $obj
...
\
  ...
  set add [ create_bd_cell -type ip -vlnv xilinx.com:hls:add:1.0 add ]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins ps8_0_axi_periph/M00_AXI] [get_bd_intf_pins add/s_axi_control]
  ...
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins rst_ps8_0_99M/peripheral_aresetn] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins add/ap_rst_n]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_99M/slowest_sync_clk] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins add/ap_clk]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -with_name SEG_add_0_Reg -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs add/s_axi_control/Reg] -force

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.584663",
   "Default View_TopLeft":"10,-234",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.7.1 2023-07-26 3bc4126617 VDI=43 GEI=38 GUI=JA:21.0 TLS
#  -string -flagsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 2 -x 660 -y -40 -defaultsOSRD
preplace inst add -pg 1 -lvl 1 -x 190 -y -90 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 4 -x 1530 -y 130 -defaultsOSRD
preplace inst rst_ps8_0_99M -pg 1 -lvl 3 -x 1180 -y -50 -defaultsOSRD
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 4 20 10 360 -140 970 70 1360
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 2 1 980 -70n
preplace netloc rst_ps8_0_99M_peripheral_aresetn 1 0 4 30 0 350J -150 990J 50 1370
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_FPD 1 2 2 1000J -150 1380
preplace netloc ps8_0_axi_periph_M00_AXI 1 0 5 40 -10 340J -160 NJ -160 NJ -160 1680
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM1_FPD 1 2 2 960J 60 N
levelinfo -pg 1 0 190 660 1180 1530 1700
pagesize -pg 1 -db -bbox -sgen -20 -170 1700 280
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse [list design_1.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../scalar_fun_vivado.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
