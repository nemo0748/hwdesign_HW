#ifndef INCLUDE_FLOAT32_ARRAY_UTILS_TB_H
#define INCLUDE_FLOAT32_ARRAY_UTILS_TB_H
...
inline void read_uint32_file_array(value_type* dst, const char* file_path, int n0) {
    ...
    read_array<32>(words.empty() ? nullptr : words.data(), dst, n0);
}
...
inline void write_uint32_file_array(const value_type* src, const char* file_path, int n0) {
    ...
    write_array<32>(src, words.empty() ? nullptr : words.data(), n0);
...
#endif // INCLUDE_FLOAT32_ARRAY_UTILS_TB_H
