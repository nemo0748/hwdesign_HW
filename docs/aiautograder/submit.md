---
title: Submitting on Gradescope
...
If you select the **dashboard** box in the top right, you will be directed to
...
We are currently trying to write an autograder on Gradescope.  Hopefully, this program
will automatically read your results and grade you.
