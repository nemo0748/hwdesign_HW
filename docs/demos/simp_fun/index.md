---
title: Basic Sequential Logic and FSMs
parent: Demos
nav_order: 2
has_children: true
---
...
Subsequent units will mostly use Vitis HLS instead
of SystemVerilog.  Vitis HLS is a higher level language
that enables rapidly implementing complex operations.
However, we start with SystemVerilog since it is low-level and let you develop a mental model
for what the hardware does.

---

Go to [Building the scalar function example](./module.md).
