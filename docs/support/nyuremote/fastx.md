---
title: Fast-X GUI connection
parent: NYU Remote Server
nav_order: 2
has_children: False
---

## Remote GUI Connection with Fast-X


You can do most of all the labs and demos from the terminal and SSH only.
...
Go to [launching Vitis and Vivado](./launching.md)